...
/*
	...
	Object를 기반으로 저장되므로 차후 값을 읽을 때는 해당 타입으로 형변환해야 한다.
*/
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<%
	//정수 데이터를 객체화할 때 Integer클래스를 통해 자동 박싱/언박싱 할 수 있다.
	int pInteger = (Integer)(pageContext.getAttribute("pageInteger"));
	//문자열 데이터는 toString()메서드를 통해 문자열 형태로 반환할 수 있다.
	String pString = pageContext.getAttribute("pageString").toString();
	//Person과 같이 개발자가 정의한 클래스는 원래의 타입으로 형변환한다.
	Person pPerson = (Person)(pageContext.getAttribute("pagePerson"));
	%>
	<ul>
		<!-- Java의 기본클래스인 경우 별도처리 없이 즉시 내용을 출력할 수 있다. -->
