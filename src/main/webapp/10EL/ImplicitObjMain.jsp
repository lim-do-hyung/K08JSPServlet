...
<body>
	...
	<!-- 
	4가지 영역에 접근할 때 EL의 내장객체를 통해 내용을 출력한다.
	...
	<!-- 
	만약 영역명 지정없이 속성을 읽을 때는 가장 좁은 영역을 우선으로 출력한다.
	즉, 여기서는 page영역의 속성을 출력하게 된다. 실무에서는 동일한 속성명으로
	저장하는 경우가 거의 없으므로 대부분 이와 같이 사용할 수 있다.
	 -->
