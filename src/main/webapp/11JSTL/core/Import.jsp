...
<body>
	...
	import 태그
		...
		url속성에 절대 경로로 지정할 경우 컨텍스트 루트명은 포함하지 않는다.
	 -->
	 <!-- request영역에 변수 저장 -->
	...
	var 속성을
		미사용시 : 해당 위치에 즉시 포함된다.
		사용시 : var에 지정한 변수는 EL로 출력하는 곳에 포함된다.
			선언과 출력을 별도로 할 수 있으므로 코드를 정리할 때 편리하다.	
	 -->
	 <!-- 
	 import태그의 하위 태그로 param을 사용할 수 있다. 지정된 페이지로 파라미터를
	 전달할 수 있다.
	  -->
	...
	<!-- 앞에서 사용한 import태그의 var 속성의 변수를 통해 출력한다. -->
	<h4>다른 문서 삽입하기</h4>
	${contents }
